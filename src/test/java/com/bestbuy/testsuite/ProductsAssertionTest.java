...
//Pack), Duracell - AA Batteries (8-Pack), Energizer - MAX Batteries AA (4-Pack))
   @Test
    public void test014(){
    response.body("data.name",hasItems("Duracell - AA Batteries (8-Pack)","Energizer - MAX Batteries AA (4-Pack)","Duracell - AA 1.5V CopperTop Batteries (4-Pack)"));
   }
...
//20. Verify the prodctId = 346575 have 5 categories
    @Test
    public void test020(){
       // List<?> listCategories = response.extract().path("data[9].categories");
